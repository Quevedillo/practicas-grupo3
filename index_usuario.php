...
<body>
    <div class="container">
        ...
        <nav class="navbar">
            <ul>
                <li><a href="index_usuario.php">Panel</a></li>
        ...
        <main class="main-content">
            <div class="dashboard-summary">
                ...
                <button class="new-ticket-button" onclick="window.location.href='creacionticket.html'">+ Nuevo Ticket</button>
            </div>
    ...
    <script>
        ...
        // Función para el botón de nuevo ticket
        document.querySelector('.new-ticket-button').addEventListener('click', function() {
            window.location.href = 'creacionticket.html';
        });
    </script>
</body>
</html>